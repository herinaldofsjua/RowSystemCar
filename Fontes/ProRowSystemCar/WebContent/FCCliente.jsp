...
<%@page import="br.com.apis.rowsystemcar.entidades.Cliente" %>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title >CADASTRAR/EDITAR CLIENTE</title>
<style type="text/css">
h1{
...
<body>
     ...
     <h1>CADASTRAR/EDITAR CLIENTE</h1>  
     ...
     <form action="clicontroller.do" method="post">
         ...
         <label>*Nome:</label>
         <input type="text" name="txtnome"  maxlength="100"  value="<%= cliente.getNome() %>" size="100"/><br><br>
         
         <label>*Login:</label>
         <input type="text" name="txtlogin"  maxlength="20"  value="<%= cliente.getLogin() %>" size="20"/>
         ...
         <label>*UF:</label>
         <input type="text" name="txtuf"  maxlength="2" value="<%= cliente.getUf() %>" size="2"/>
         
         <p>Os campos com "*" são obrigatórios!</p><br><br>
